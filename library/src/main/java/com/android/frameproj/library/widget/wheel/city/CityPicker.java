...
import com.android.frameproj.library.util.FileUtil;
...
public class CityPicker extends LinearLayout {
	...
	public static class JSONParser {
		...
		public List<Info> getJSONParserResult(String JSONString, String key) {
		...
		public HashMap<String, List<Info>> getJSONParserResultArray(
				String JSONString, String key) {
			HashMap<String, List<Info>> hashMap = new HashMap<String, List<Info>>();
			JsonObject result = new JsonParser().parse(JSONString)
					.getAsJsonObject().getAsJsonObject(key);
			...
			while (iterator.hasNext()) {
				...
				for (int i = 0; i < array.size(); i++) {
					Info info = new Info();
					info.setCity_name(array.get(i).getAsJsonArray().get(0)
							.getAsString());
					info.setId(array.get(i).getAsJsonArray().get(1)
							.getAsString());

...
public class OrderAppealingFragment extends BaseFragment implements OrderAppealingContract.View,
        LoadMoreWrapper.OnLoadMoreListener, PtrHandler {

    public static BaseFragment newInstance() {
        OrderAppealingFragment orderWaitingAcceptFragment = new OrderAppealingFragment();
        return orderWaitingAcceptFragment;
    }

    @Inject
    OrderAppealingPresenter mPresenter;

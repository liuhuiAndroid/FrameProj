...
public class MyReasonsPresenter implements MyReasonsContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private MyReasonsContract.View mView;
    private CommonApi mCommonApi;

    @Inject
    public MyReasonsPresenter(CommonApi commonApi) {
        this.mCommonApi = commonApi;
    }

    @Override
    public void dictionaryQuery() {
        disposables.add(mCommonApi.dictionaryQuery(3)
    ...
    @Override
    public void attachView(@NonNull MyReasonsContract.View view) {
        mView = view;
    }

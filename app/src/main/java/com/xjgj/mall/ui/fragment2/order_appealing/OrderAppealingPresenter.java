 ...
 */
@PerActivity
public class OrderAppealingPresenter implements OrderAppealingContract.Presenter {


    private final CompositeDisposable disposables = new CompositeDisposable();
    private OrderAppealingContract.View mView;
    ...
    @Inject
    public OrderAppealingPresenter(CommonApi commonApi, Bus mBus) {
    ...
    @Override
    public void attachView(@NonNull OrderAppealingContract.View view) {
        mView = view;
    }

package com.xjgj.mall.ui.fragment2.order_evaluated;
 ...
 */
@PerActivity
public class OrderEvaluatedPresenter implements OrderEvaluatedContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private OrderEvaluatedContract.View mView;
    ...
    @Inject
    public OrderEvaluatedPresenter(CommonApi commonApi, Bus mBus) {
    ...
    @Override
    public void attachView(@NonNull OrderEvaluatedContract.View view) {
        mView = view;
    }

...
public class OrderEvaluatedFragment extends BaseFragment implements OrderEvaluatedContract.View,
        LoadMoreWrapper.OnLoadMoreListener, PtrHandler {

    public static BaseFragment newInstance() {
        OrderEvaluatedFragment orderWaitingAcceptFragment = new OrderEvaluatedFragment();
        return orderWaitingAcceptFragment;
    }

    @Inject
    OrderEvaluatedPresenter mPresenter;

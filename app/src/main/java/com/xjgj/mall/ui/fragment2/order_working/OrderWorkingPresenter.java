 ...
 */
@PerActivity
public class OrderWorkingPresenter implements OrderWorkingContract.Presenter {


    private final CompositeDisposable disposables = new CompositeDisposable();
    private OrderWorkingContract.View mView;
    ...
    @Inject
    public OrderWorkingPresenter(CommonApi commonApi, Bus mBus) {
